...
from opponent1 import opponent as opponent1 # random player
from opponent2 import opponent as opponent2 # more strategic player
...
if __name__ == "__main__":
    ...
    # testgame(p_white=opponent, p_black=agent, board_sample=sample0)
